...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        this.form = new forms_1.FormGroup({
            login: new forms_1.FormControl('', [forms_1.Validators.required, forms_1.Validators.pattern('^[a-zA-Z0-9]+$')]),
    ...
    AppComponent.prototype.checkEmail = function (control) {
        ...
        return new Promise(function (resolve) {
            setTimeout(function () {
                var emailExists = emails.some(function (email) { return email.email === control.value; });
                if (emailExists) {
